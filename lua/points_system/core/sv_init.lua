...
-- function IVG.AddCommand(commandName, commandData)
--   IVG.Commands[commandName] = commandData
-- end
-- IVG.AddCommand "setstuds" {
--   callBack = function(ply, args)
--     -- Player Object
--     local target = args[2]
--     local studAmount = args[3]
